 ...
 */
  ...
  __pyx_v_self->thisptr = new FFLD::FFLDDetector(__pyx_t_3);
...
static PyObject *__pyx_pf_13ffld_detector_14PyFFLDDetector_4detect(struct __pyx_obj_13ffld_detector_PyFFLDDetector *__pyx_v_self, PyArrayObject *__pyx_v_image) {
  std::vector<FFLD::Detection>  __pyx_v_detections;
  FFLD::Detection __pyx_v_d;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_image;
  __Pyx_Buffer __pyx_pybuffer_image;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  std::vector<FFLD::Detection> ::iterator __pyx_t_2;
  FFLD::Detection __pyx_t_3;
  ...
  __pyx_pybuffernd_image.rcbuffer = &__pyx_pybuffer_image;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_image.rcbuffer->pybuffer, (PyObject*)__pyx_v_image, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 87, __pyx_L1_error)
  }
 ...
 */
  __pyx_v_detections = __pyx_v_self->thisptr->run(((npy_intp)(__pyx_v_image->dimensions[1])), ((npy_intp)(__pyx_v_image->dimensions[0])), 1, ((uint8_t const *)__pyx_v_image->data));
 ...
 */
  ...
  for (;;) {
    ...
    __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_d.left()); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_d.top()); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_d.right()); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_d.bottom()); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 104, __pyx_L1_error)
