...
cdef extern from "Detector.hpp":
    cdef cppclass Detection:
        ...
        int z #
        int bx0 # 
        int by0 # ограничивающий прямоугольник
        int bx1 #
        int by1 #
...
cdef class PyFFLDDetector:
    ...
    def detect(self, np.ndarray[np.uint8_t, ndim=3, mode="c"] image):
        """
